...
Процедура ПриПолученииНаименованийНаборовСвойств(Наименования, КодЯзыка) Экспорт
	Наименования["Справочник_ДемоКонтрагенты_Основное"] = НСтр("ru='Основное'; en='Main';", КодЯзыка);
	Наименования["Справочник_ДемоКонтрагенты_Прочее"]   = НСтр("ru='Прочее'; en='Other';", КодЯзыка);
	...
	Наименования["Справочник__ДемоНоменклатура_Общие"] = НСтр("ru='Общие'; en='General';", КодЯзыка);
КонецПроцедуры
