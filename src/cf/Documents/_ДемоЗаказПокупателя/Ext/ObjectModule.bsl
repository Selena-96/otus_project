...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	НачалоЗамераЗапись = ОценкаПроизводительности.НачатьЗамерВремени();
...
Процедура ПриЗаписи(Отказ)
	...
	ОценкаПроизводительности.ЗакончитьЗамерВремени("ЗаказКлиентаЗапись", НачалоЗамераЗапись);
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	ОценкаПроизводительности.ЗакончитьЗамерВремени("ЗаказКлиентаПроведение", НачалоЗамераЗапись);
