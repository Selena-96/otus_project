...
Процедура ОткрытьXMLФайл(Знач ФайлXMLАдрес, Знач ФайлXMLИмя, Знач XML,
	...
	Исключение
		...
		Исключение
			ЗаписьЖурналаРегистрации(НСтр("ru = 'Редактирование манифеста обработки поставляемых данных.Не удалось удалить временный файл'", ОбщегоНазначения.КодОсновногоЯзыка()), 
