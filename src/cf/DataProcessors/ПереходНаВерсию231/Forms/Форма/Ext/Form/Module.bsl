...
Процедура ЗаполнитьСоставОпределяемыхТипов()
	...
	Если ПодсистемаВнедрена("УправлениеДоступом") Тогда
		...
		// ЗначениеДоступаОбъект для подписки ОбновитьГруппыЗначенийДоступа.
...
Процедура СоставОпределяемогоТипаГруппаЗначенийДоступаОбъект()
	...
	ФайлГруппаЗначенийДоступаОбъект = ИмяФайлаПоИмениОбъектаИТипу("DefinedType", "ЗначениеДоступаОбъект");
	...
	СоответствиеТекущее = СоставОпределяемогоТипаВСоответствие(СоставНовогоТипа, "ЗначениеДоступаОбъект");
