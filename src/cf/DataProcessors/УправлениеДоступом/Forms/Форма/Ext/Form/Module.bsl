...
Процедура ОбновитьТекстыОграниченияСпискаДляВидаПользователей(Свойства, ДляВнешнихПользователей, ДополнительныеПараметры)
	...
	Элементы["ПроверитьТекстОграничения" + Окончание].Видимость = Истина;
	Элементы["ПроверитьТекстОграниченияЖирныйШрифт" + Окончание].Видимость = Ложь;
	...
	Если ЗначениеЗаполнено(Свойства.ТекстОшибокОграничения)
	 Или Свойства.ОграничениеПоВладельцуВозможно = Истина
	   И (ДополнительныеПараметры = Неопределено
		...
		Элементы["РассчитатьОграничениеВРоли" + Окончание].Видимость = Ложь;
		Элементы["РассчитатьОграничениеВРолиЖирныйШрифт" + Окончание].Видимость = Истина;
	Иначе
		Элементы["РассчитатьОграничениеВРоли" + Окончание].Видимость = Истина;
		Элементы["РассчитатьОграничениеВРолиЖирныйШрифт" + Окончание].Видимость = Ложь;
	КонецЕсли;
...
Процедура ПриИзмененииТекстаОграничения(ДляВнешнихПользователей)
	...
	Элементы["ПроверитьТекстОграничения" + Окончание].Видимость = Ложь;
	Элементы["ПроверитьТекстОграниченияЖирныйШрифт" + Окончание].Видимость = Истина;
