...
Процедура ВывестиДеталиСИерархией(ОбщиеДетали, Результат, ПараметрыВыводаЗапроса , Уровень, КоличествоКолонок, ИндексСтроки)
...
Процедура ВыключениеТехнологическогоЖурнала(КаталогСЛогФайлами) Экспорт
	...
	Попытка
		УдалитьФайлы(КаталогСЛогФайлами, ПолучитьМаскуВсеФайлы());
	Исключение
